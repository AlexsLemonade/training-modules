...
- [ ] Update [`current-modules.json`](https://github.com/AlexsLemonade/training-modules/blob/master/current-modules.json) with the release tag and the modules that will be included in this training event, [as described here](https://github.com/AlexsLemonade/training-modules/blob/master/workshop-releases.md#select-training-modules-in-current-modulesjson) .

...
Add `facet_wrap()` to `treatment_plot` (saving `treatment_plot`) such that each dosage is its own facet and use `scale_color_manual(values = palette.colors(palette = "Okabe-Ito"))`.

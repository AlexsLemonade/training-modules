...
|-----------------------------------------|---------------------------------------------|-------------------------|------------------------------------------------------------------------|
| `AnnotationDbi`        | [`keytypes()`](https://www.rdocumentation.org/packages/AnnotationDbi/versions/1.44.0/topics/AnnotationDb-objects)      | Keytypes     | Returns a character vector of column names (keytypes)                                               |
| `AnnotationDbi`       | [`mapIDs()`](https://www.rdocumentation.org/packages/AnnotationDbi/versions/1.44.0/topics/AnnotationDb-objects) | Mapped IDs       | Extracts the mapped ids for a set of keys of a specific keytype                                    |                                  
...
| Base `R`               | [`cor()`](https://www.rdocumentation.org/packages/stats/versions/3.6.1/topics/cor)        | Correlation     | Computes correlation between samples using a specified correlation method, and returns a correlation matrix        |
...
| Base `R`               | [`cbind()`](https://www.rdocumentation.org/packages/base/versions/3.5.1/topics/cbind)                | Cbind                          | Combines R objects using specified columns or rows                                         |
| Base `R`               | [`paste0()`](https://www.rdocumentation.org/packages/base/versions/3.5.1/topics/paste)     | Concatenate Strings              | Joins together strings after they have been converted to character vectors      |
...
| [`reshape2`](https://www.rdocumentation.org/packages/reshape2/versions/1.4.3)             | [`melt()`](https://www.rdocumentation.org/packages/reshape2/versions/1.4.3/topics/melt)         | Melt             | Converts an object into a data.frame                                                                           |
...
| [`ggsignif`](https://www.rdocumentation.org/packages/ggsignif/versions/0.4.0)             | [`geom_signif()`](https://www.rdocumentation.org/packages/ggsignif/versions/0.4.0/topics/stat_signif)    | Create Significance Layer   | Computes the significance of the difference between groups and adds this annotation to the plot        |
...
| Library/Package               | Piece of Code                                                 | What it's called      | What it does                                                             |
|-------------------------------|--------------------------------------------------------------|--------------------------------|--------------------------------------------------------------------------|
| `DESeq2`                | [`rlog()`](http://rstudio/help/library/DESeq2/html/rlog.html)                   | Regularized Log Transformation                  | Returns log2 transformed count data                                      |                                                                                         
...
| [`dplyr`](https://www.rdocumentation.org/packages/dplyr/versions/0.7.8)                 | [`pull()`](https://www.rdocumentation.org/packages/dplyr/versions/0.7.8/topics/pull)                      | Pull                              | Extracts a variable as a vector                                          |                                                                                       
...
<br>
![Useful Command Line Commands](command_line_example.jpeg)

...
*For more comprehensive tutorials:*  
  - For a tutorial on R, RStudio and R Markdown: https://ismayc.github.io/rbasics-book/  
  - [Datacamp](https://www.datacamp.com/) has lots of good tutorials for R and the intro ones are free.       
  - For a lot of handy R cheatsheets: https://www.rstudio.com/resources/cheatsheets/  
...
The `c` function allows us to *concatenate* ie. put multiple things together in one vector.

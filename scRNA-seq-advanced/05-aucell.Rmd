...
The scores or values we get out of AUCell are the area under a recovery curve and estimate the proportion of genes in the gene set that are highly expressed (i.e., highly ranked).
...
scater::plotUMAP(sce, colour_by = "zhang_auc") +
  ...
  ggplot2::ggtitle(stringr::str_replace_all(ewing_gene_set_names[1], 
                                            "\\_", 
                                            " "))
```
...
scater::plotUMAP(sce, colour_by = "riggi_auc") + 
  ggplot2::ggtitle(stringr::str_replace_all(ewing_gene_set_names[2], 
                                            "\\_", 
                                            " "))
```

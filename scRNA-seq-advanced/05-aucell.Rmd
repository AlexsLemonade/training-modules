...
The first step in AUCell is to rank genes for each cell from highest to lowest value.
We can do this using the `AUCell_buildRankings()` function, which will output a visualization the distribution of the number of genes detected in the cells in our SingleCellExperiment object.

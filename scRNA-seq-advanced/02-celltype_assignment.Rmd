...
```{r}
type_cluster_tab <- table(sce$celltype_fine, sce$nn_cluster)

# Normalize by cluster size (columns)
...
type_cluster_tab <- scale(type_cluster_tab, 
                          center = FALSE, 
                          scale = colSums(type_cluster_tab))

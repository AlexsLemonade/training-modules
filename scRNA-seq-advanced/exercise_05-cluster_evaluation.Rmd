...
In the following chunk, print out the resulting `cluster_silhouette_df` to see what we have created:
...
Save this result to `cluster_purity_df`, and print the data frame once you have created it.

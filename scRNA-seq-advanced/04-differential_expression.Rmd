...
In the below plot we will color our cells by cell type but we will also use `facet_grid()` to plot the cells from each subdiagnosis in their own separate panel of the plot.

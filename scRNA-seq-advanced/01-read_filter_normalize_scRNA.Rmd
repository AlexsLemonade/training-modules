...
Some of these functions for other common data formats are discussed in [Chapter 3 of OSCA](http://bioconductor.org/books/3.22/OSCA.intro/getting-scrna-seq-datasets.html#reading-counts-into-r).
...
The overall structure of the object can be seen in the figure below, which comes from an [OSCA Introduction chapter](http://bioconductor.org/books/3.22/OSCA.intro/the-singlecellexperiment-class.html).
...
The procedure we will use here is derived from the [OSCA chapter on normalization](http://bioconductor.org/books/3.22/OSCA.basic/normalization.html#normalization-by-deconvolution).

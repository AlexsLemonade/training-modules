...
We will perform our clustering using the function `scran::clusterCells` package, which can perform many different types of clustering using the Bioconductor `bluster` package under the hood.

...
As the differential expression results showed, FOXO1 is upregulated in ARMS in mesoderm cells and myoblasts, but appears to be almost equally highly expressed in myocytes in both disease sub types. 
...
I did find this statement from the paper, "ARMS tumors contained significantly fewer cells with the mesodermal gene expression signature and were skewed towards the myocyte signature." 

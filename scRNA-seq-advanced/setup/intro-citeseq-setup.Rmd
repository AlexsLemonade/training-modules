...
#  stored experiement information
...
We'd, if there's no contamination, that there are 0 counts for this protein since the data is human:
...
We can leverage the ADTs as protein markers to identify likely celltypes.
...
It might be helpful to hone in on the most prevalent celltypes only for ease of visualization, but this is a bit more advanced to dive into.

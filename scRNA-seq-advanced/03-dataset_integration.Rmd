...
Here is a schematic of what this wrangling will look like, **but a lot of the text that explains the technical steps happens in the next chunks and subsection so should this diagram be lower?**
...
Something we can see already from this UMAP is that the non-tumor cell types (mostly vascular endotheliem, muscle cells, and monocytes) tend to cluster together and are generally far separated from the tumor cell types, which is an encouraging pattern!

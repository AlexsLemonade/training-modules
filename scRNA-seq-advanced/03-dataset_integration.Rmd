...
This database currently hosts (as of March 2023) eleven projects from eight different ALSF-funded labs who have generated single-cell pediatric cancer transcriptomic data with the ultimate goal of making this data easily accessible to investigators (like you!).
`ScPCA` raw data is processed with [nextflow pipeline](https://github.com/AlexsLemonade/scpca-nf) that uses [`alevin-fry`](https://doi.org/10.1038/s41592-022-01408-3) for fast and efficient mapping, followed by filtering and normalization with Bioconductor tools. 

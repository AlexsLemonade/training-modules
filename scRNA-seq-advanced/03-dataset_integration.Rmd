...
The mapping function from the original data to the reduced dimensions will also be separately calculated, so the new coordinates won't have consistent meanings across samples.

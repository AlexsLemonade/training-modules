...
Funded by ALSF, this database currently hosts projects from ten different ALSF-funded labs who have generated single-cell pediatric cancer transcriptomic data with the ultimate goal of making this data easily accessible to investigators.

Specifically, we'll have a look at four libraries from the [`SCPCP000005` project](https://scpca.alexslemonade.org/projects/SCPCP000005), which contains rhabdomyosarcoma (RMS) data ([Patel _et al._ (2022)](https://doi.org/10.1016/j.devcel.2022.04.003)).
This data is part of an overall project led by the [Dyer](https://www.stjude.org/research/labs/dyer-lab.html) and [Chen](https://www.stjude.org/research/labs/chen-lab-taosheng.html) labs at St. Jude Chidren's Research Hospital to characterize the heterogeneity of pediatric solid tumors.
...
RDS files with the results of this preprocessing, stored as SCE objects, are available in the `data/rms/integration/` directory. 
...
These columns contain putative _cell type annotations_ as assigned in [Patel _et al._ (2022)](https://doi.org/10.1016/j.devcel.2022.04.003). 

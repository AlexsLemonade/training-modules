...
The particular samples we'll integrate come from two rhabdomyosarcoma (RMS) patients, with two samples from two patients each, and all samples are single-nuclei and were sequenced with 10Xv3 technology.
...
Recall, these are the SCE files:
...
```{r read input} 
# Vector of all the sample names to read in:

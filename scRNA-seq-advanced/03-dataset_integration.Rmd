...
scater::plotReducedDim(merged_sce,
  ...
  guides(colour = ggplot2::guide_legend(override.aes = list(size = 3, alpha = 1))) +
  # Add a plot title
  ggplot2::ggtitle("UMAP calculated on each library separately")
```
...
scater::plotReducedDim(merged_sce,
  ...
  guides(colour = ggplot2::guide_legend(override.aes = list(size = 3, alpha = 1))) +
  # Add a plot title
  ggplot2::ggtitle("UMAP calculated on merged_sce")
```

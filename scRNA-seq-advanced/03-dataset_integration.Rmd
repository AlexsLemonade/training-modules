...
The [`batchelor::multiBatchPCA()`](https://rdrr.io/bioc/batchelor/man/multiBatchPCA.html) function calculates a batch-weighted PCA matrix, namely by ensuring that batches, which may have very different numbers of cells, contribute equally to the overall scaling.
...
We want to use the batch-weighted PCA, which is called `"merged_PCA"`.

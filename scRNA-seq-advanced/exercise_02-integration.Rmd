...
A few methods are discussed in the friendly OSCA Book chapter on [Correction Diagnostics](http://bioconductor.org/books/3.22/OSCA.multisample/correction-diagnostics.html).
...
One way to quantify changes in clustering is to use a measure like [adjusted Rand index (ARI)](http://bioconductor.org/books/3.22/OSCA.advanced/clustering-redux.html#adjusted-rand-index).

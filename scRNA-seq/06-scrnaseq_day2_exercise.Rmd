...
Note that our data in `sce` has cell ids in `colData` (*e.g.*`CAGTCCTTCGGAGCAA`) but without the sample ids at the front end like is in our `metadata` (*e.g.* `10X_P7_0_CAGTCCTTCGGAGCAA`). 

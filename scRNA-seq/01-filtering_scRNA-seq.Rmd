...
We will discuss *tag-based* scRNA-seq data (such as 10X), in a later notebook, 
...
all(samples %in% sc_metadata$geo_accession)
```
...
# save as sc_data_filtered2
sc_data_filtered2 <- sc_data_filtered[num_samples_exp >= cutoff, ]
```

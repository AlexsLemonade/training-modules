...
- Normalize expression counts to better compare expression aming cells
- Explore the effects of normalization on variation among cells

---

In this notebook, we'll continue to process the same dataset that we have been working with, perform normalization of scRNA-seq count data that we have already done quality-control analyses of.

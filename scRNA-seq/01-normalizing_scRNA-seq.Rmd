...
ggplot(var_stats, aes(x = gene.mean, y = gene.dispersion.scaled, color = var_group)) +
  ...
  geom_vline(xintercept = .1, size = .5, alpha = .2) +  # Here we are plotting our variance cutoff
  geom_hline(yintercept = 1, size = .5, alpha = .2)  # Here we are plotting our expression cutoff
```

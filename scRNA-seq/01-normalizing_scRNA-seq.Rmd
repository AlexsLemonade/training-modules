...
also has a corresponding function that allows you to extract (or set)
the resulting information from that transformation. 

![](figure/sce_structure.png)
...
Also note that `readr` requires `data.frame`s so we converted our `matrix` 
to a data.frame.

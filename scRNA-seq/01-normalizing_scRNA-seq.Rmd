...
In the intro-to-R-tidyverse module, we discuss base R object types, but there 
are sometimes 'special' object types that are package-specific. 
...
the resulting information that is stored in the object from that transformation. 

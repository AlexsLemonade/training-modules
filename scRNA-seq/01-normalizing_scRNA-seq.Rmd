...
```{r Apply filter}
# Put the gene names back as a column and GeneMatrixFilter will handle it
...
```{r}
readr::write_tsv(sc_metadata_filtered, file.path("data", "gbm_filtered_metadata.tsv"))
```
...
readr::write_rds(sce_norm, file.path("data", "sce_norm.RDS"))
```

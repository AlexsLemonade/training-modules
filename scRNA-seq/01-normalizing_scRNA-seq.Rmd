...
- Alternatively, zeroes arise from _technical_ issues, such as an expressed 
gene that was not detected by sequencing. 
This is called  gene _dropout_. 
...
This is not out of the ordinary for single-cell RNA-seq data. 
...
These kinds of things are to be expected; it's highly unlikely that all cells
within the set have reliable, high-quality data.

...
We can use `set.seed()` to be sure that an individual run (or set of runs) is the same every time, but it is important to check your results a few times to be sure that the random component is not giving you anomalous results.

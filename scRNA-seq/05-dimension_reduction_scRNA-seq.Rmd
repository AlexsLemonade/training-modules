...
tm_normalized <- file.path("data", "tabula-muris", 
...
It looks like there are a few different clusters here, which may represent different kinds of cells within this tissue.

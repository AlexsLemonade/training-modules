...
cell-types. 
We will do this first by extract the gene data and making a heatmap of the means
of select genes by cell-type. 
Next, we will recreate a PCA plot but color the 
points by the gene data. 

...
This is glioblastoma data that was Fluorescence-Activated Cell Sorted (FACS) 
...
interest by using cell-types. 
We will do this first by extracting the gene data and making density plots.
...
Here we are extracting the gene names from `sce_norm`. We've done this step for 
you. Run the code chunk below and see what `genes` object gives you.
...
among the cell-types in our dataset. 

Use https://www.genecards.org/ and pick a gene of your own liking to add to 
this analysis. 
...
On your own time, if you'd like to make a heatmap and play around with it a bit
more, we recommend using the package `ComplexHeatmap` and following their 
[excellent vignettes](https://jokergoo.github.io/ComplexHeatmap-reference/book/)
to practice making heatmaps. 
...
to one of the marker gene's expression data. 
...
After you have successfully used this, repeat this `ggplot` template for the 
other genes in your marker list. 

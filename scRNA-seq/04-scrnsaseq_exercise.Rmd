...
In this exercise, we will be using the This [Darmanis data](https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE84465) we normalized and filtered in `01-normalizing_scRNA`. 
...
to transpose the data, and tell R to ignore the gene column). 

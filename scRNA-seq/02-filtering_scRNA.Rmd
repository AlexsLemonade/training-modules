...
We'll also tell `tximeta()` to only read in the barcodes that `alevinQC` decided passed quality control.
...
bladder_sce <- tximeta(coldata, type = "alevin", alevinArgs = list(filterBarcodes=TRUE))
```

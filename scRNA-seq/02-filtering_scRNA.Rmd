...
Even as we zoom in, the counts data has many zeroes, which we actually expect in a single cell RNA-seq experiment (and even more so in a partial data set like this one).
...
Yikes, one of the samples has only 22 counts, compared to the median of 1001!

...
For more extensive background on single-cell experimental methods, Predeus _et al._ also have a very good [tutorial for scRNA-seq](https://www.singlecellcourse.org).
We will also refer extensively to the the book [_Orchestrating Single-Cell Analysis with Bioconductor_](https://bioconductor.org/books/release/OSCA/) (Amezquita _et al._)

![**Overall view of scRNA-seq tag-based workflow**](diagrams/roadmap_single_overview.png)
...
- [_Orchestrating Single Cell Analysis with Bioconductor_](https://bioconductor.org/books/release/OSCA/)

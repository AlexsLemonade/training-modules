...
Although packages like `scater` have built in methods for performing t-SNE, we
want to show you a method that can be applied to most any data so long as it 
is in a matrix.

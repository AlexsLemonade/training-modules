...
([Here's the project itself!](https://data.humancellatlas.org/explore/projects/c41dffbf-ad83-447c-a0e1-13e689d9b258))
...
mkdir -p ${data_dir}
wget --quiet -O ${data_dir}/healthy_cirrhotic_mouse_liver.loom "https://storage.googleapis.com/broad-datarepo-terra-prod-hca2-bucket/d30e68f8-c826-4639-88f3-ae35f00d4185/222d6d0f-f8d2-40ff-8dd2-cdbe4e6871f2/healthy-cirrhotic-mouse-liver-10XV2.loom?Expires=1624062635&GoogleAccessId=azul-ucsc-0-prod%40platform-hca-prod.iam.gserviceaccount.com&Signature=JzwpAlcJ1eq0Tf7FiqDTJb5sz2YXQ8oUnJIWyTQeWL2MZaqnlMUMtsUOaAFwO3FuotUmeg3wCtF%2B3io%2FNSGj4C%2Fu54Sz6Ei5M04wwn1NNRm9UTuckgnVVTfE6Q0gy%2FxFy7YJ53bnw%2FWGj0%2F9AbnXKCpLyCcR4cNmAeSyhxi1lBqJbyQmVK%2Fte6Fvj5bSJ1OPQ%2BShYONcm9yHSfMAVJ1GJ%2FYMt%2BuRR185jENUgpE72H60sIk09AoJn502bICGipWFpjcb1QhPk9g7KpIUejWRccEEM5HdqXNC2bdAzjuJII98ItDVbuasw7axFnbBfk2m%2BOvgIl1H0smNH%2FZv2b7mwg%3D%3D&response-content-disposition=attachment%3B+filename%3Dhealthy-cirrhotic-mouse-liver-10XV2.loom"
```
...
Write each table of marker genes, sorted by FDR, to file.

```{r}
# Assign, because otherwise this is _chatty_

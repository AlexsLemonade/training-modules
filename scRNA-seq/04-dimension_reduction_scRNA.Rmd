...
![QC and filtering](diagrams/roadmap_single_qc_norm.png)
...
This method, described in , uses the droplets with very low UMI counts to estimate the "ambient" expression pattern of RNA content outside of cells.
...
The `emptyDropsCellRanger()` function takes the `counts` matrix from our SingleCellExperiment, and returns a data frame with the statistics it calculated.
...
![Dimensionality reduction](diagrams/roadmap_single_dimension_reduction.png)

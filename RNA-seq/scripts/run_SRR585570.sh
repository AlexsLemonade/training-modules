...
fastp -i data/fastq/gastric_cancer/SRR585570_1.fastq.gz \
	-I data/fastq/gastric_cancer/SRR585570_2.fastq.gz \
	-o data/fastq/gastric_cancer/SRR585570_fastp_1.fastq.gz \
	-O data/fastq/gastric_cancer/SRR585570_fastp_2.fastq.gz \
...
salmon quant -i index/Homo_sapiens/short_index \
	-l A \
    -1 data/fastq/gastric_cancer/SRR585570_fastp_1.fastq.gz \
    -2 data/fastq/gastric_cancer/SRR585570_fastp_2.fastq.gz \

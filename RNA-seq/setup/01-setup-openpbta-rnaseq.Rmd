...
stranded_count_mat <- readr::read_rds(count_tmp)
```
...
```{r}
sc_exp <- SummarizedExperiment(assays = list(counts = stranded_count_mat),
                               colData = histologies_df)
readr::write_rds(sc_exp, file = rnaseq_summarized_exp_file)
```

...
The `assays` in this `SummarizedExperiment` hold the experiment data, in this case, a gene x sample matrix with gene-level abundance information. 
...
If we want to extract an `assay` itself, we can use `assay()` function and 

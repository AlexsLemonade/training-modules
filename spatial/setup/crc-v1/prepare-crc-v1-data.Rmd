---
title: "Prepare Colorectal Cancer Visium v1 dataset"
...
This notebook prepares this [colorectal cancer sample from 10x](https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSM8478586), which was processed with `Space ranger v1` for analysis in the workshop by performing filtering and normalization.
...
Confirm that the data has mitochrondrial genes; we expect it does at v1 technology.

...
```{r plot-visium, live = TRUE, fig.width = 7}
...
```{r plot-coords, live = TRUE, fig.width = 7}
# plot just the spots
...
ggspavis::plotVisium(
  ...
  # custom palette: red spots are not over tissue
  pal = c("red", "gray")
)
```
...
```{r plot global filter, fig.width = 7}

...
- `cutoff`: Threshold for identifying outliers; Default is 3, meaning 3 standard deviations from the mean (think z-scores)
  - Can make this higher to be more stringent, lower to be less stringent, but don't go too high or low or you're not detecting outliers anymore
...
**TODO: probably add more intermediate exploration of each filter?**

...
- Can be used to find both individual outlying spots as well as so-called "hangnails" which are regional artifacts caused by e.g. issues in tissue prep or other technical issues
  - Note that hangnail detection tends to be really aggressive, so don't trust the defaults!
...
**TODO: I don't know how I feel about including the next chunk - who has thoughts? Leaning very much towards removing it, but wanted to include for now in case it sparks an idea during review!** 
...
TODO: more intermediate plotting?

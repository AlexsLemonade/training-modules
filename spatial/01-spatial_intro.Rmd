...
In this particular Visium data set, spots are laid out on a 6.5x6.5 mm slide.
...
In particular, this dataset was sequenced with an older Visium technology version, but most current Visium experiments will use CytAssist technology.
There are two additional image files for CytAssist experiments you should be aware of:

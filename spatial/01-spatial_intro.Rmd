...
```
Even though mitochondrial percentages are fairly low across all spots, this approach helps us find spots that are aberrantly low within their neighborhood, all of which we would miss with global filtering (where we might pick a threshold of 15-25% for single-cell data).

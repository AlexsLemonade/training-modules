...
Because the model fit was unconstrained, the per-spot weights do not exactly sum to 1.
...
Either way, we will proceed by applying a 0.1 proportion threshold to filter out cell type labels that may be noise. 
...
Taking the log gives a symmetric scale centered at 0: a value of 0 indicates co-occurrence matches random chance, positive values indicate the pair tends to share spots more than expected, and negative values indicate they tend not to co-occur.

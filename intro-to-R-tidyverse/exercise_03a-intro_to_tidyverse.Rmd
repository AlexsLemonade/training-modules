...
Now that we've cleaned our metadata, let's save it to a file named 
"cleaned_metadata_GSE19578.tsv" using `readr::write_tsv()`.
...
If you haven't, don't forget to add x- and y-axis labels to your plot so your 

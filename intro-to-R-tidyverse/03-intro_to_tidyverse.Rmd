...
### III) Manipulating data.frames

**Strategy:** 
Borrow from sjspielman's [05-introduction-dplyr](http://htmlpreview.github.io/?https://github.com/sjspielman/datascience_for_biologists/blob/master/rmd_lessons/05-introduction-dplyr.html) and [06-more-wrangling](http://htmlpreview.github.io/?https://github.com/sjspielman/datascience_for_biologists/blob/master/rmd_lessons/06-more-wrangling.html) and our already existing [intro to tidyverse](https://github.com/AlexsLemonade/training-modules/blob/master/intro-to-R-tidyverse/02-intro_to_tidyverse.Rmd).

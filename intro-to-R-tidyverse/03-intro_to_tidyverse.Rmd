...
While there are some minor differences, you can mostly treat them interchageably as long as you load the `magrittr` package or `dplyr`, which also loads that version of the pipe.

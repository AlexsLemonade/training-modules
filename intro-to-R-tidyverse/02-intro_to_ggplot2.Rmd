...
We can change the x and y labels, as well as add an overall plot title, using the `labs()` function.
...
ggplot(
  ...
  facet_wrap(~contrast) +
  labs(
    x  = "log2 Fold Change", # Now that this includes the other contrasts,we'll make this label more general
    y = "-log10 p value",
    color = "Average expression"
  ) +

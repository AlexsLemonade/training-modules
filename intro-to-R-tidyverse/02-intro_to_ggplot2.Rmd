...
We performed two sets of contrasts:  
...
Turns out, we don't have to plot each contrast separately, instead, we can use the original data frame that contains both contrasts' data, `stats_df`, and add a `facet_wrap` to make each contrast its own plot. 

...
```{r}
ggplot(tumor_normal_df, # This first argument is the data.frame with the data we want to plot
       aes(x = log_fold_change, # This is the column name of the values we want to use 

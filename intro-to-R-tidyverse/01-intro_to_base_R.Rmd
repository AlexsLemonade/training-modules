...
In most situations, we will be reading in data from a file and using it as a data frame. 
...
You'll notice each argument is in quotes, we specify `data` first because it the file, `gene_results_GSE44971.tsv` is in the `data` folder. 

...
You can start by adding a labels with `labs()`, and then by getting inspiration
from this [handy cheatsheet for ggplot2](https://raw.githubusercontent.com/rstudio/cheatsheets/main/data-visualization.pdf).

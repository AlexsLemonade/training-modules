...
We have VST transformed RNA-seq data, annotated with gene symbols, that has been collapsed such that there are no duplicated gene identifiers; see [this setup notebook for more information](https://github.com/AlexsLemonade/training-modules/blob/master/pathway-analysis/setup/02-prepare_openpbta_MB_data.Rmd).

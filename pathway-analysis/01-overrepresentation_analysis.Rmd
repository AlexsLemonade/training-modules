...
<!--TODO: Numbering of notebook will change--> 
...
If we are unable to include a gene because, for example, it had low mean expression in our experiment and therefore was filtered out in our `tidyr::drop_na()` step, we shouldn't include in our background set.  

...
random_gene_sets <- 
  purrr::map(
    1:100,  # Repeat the function 100 times
    ~ purrr::map(
        # For the list of gene set sizes
        gene_set_size, 
  ...
  # The function above will return a list of lists, remove one layer of the 
  # hierarchy with flatten()
  purrr::flatten()

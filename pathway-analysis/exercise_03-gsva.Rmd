...
```{r plot_output}
plots_dir <- "plots"
fs::dir_create(plots_dir) # ensure directory exists
...
```{r split_gene_sets}
# the entrez ids are stored in the `ncbi_gene` column of `gene_set_df`
gene_set_list <- split(gene_set_df$ncbi_gene, gene_set_df$gs_name)
```

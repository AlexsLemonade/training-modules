...
### About directories
Before we can import the file we need though, we should double check what
directory R is in, aka what our current *directory* is. 
...
metadata_edit <- arrange(metadata_edit, histology)
metadata_edit <- filter(metadata_edit, follow_up_mths > 50)
metadata_edit <- select(metadata_edit, sample_id, sex, organism)
```

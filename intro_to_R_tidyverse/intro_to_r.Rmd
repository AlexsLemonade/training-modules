...
Just like in math, 
*functions* are things that take input, transform or otherwise do something with
this input, and then give you output. 
...
It's also good practice to show other people your session info so they

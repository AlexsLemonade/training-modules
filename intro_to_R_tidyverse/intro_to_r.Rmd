...
Here let's assign the value of `1` to `x`.
```{r Basic assignment}
...
Side note about the above line: when you are naming objects, its best to stay 
...
In R, there are a few types of logical expressions: 
  ...
  `!=` : Is this not equal? Exclamation points reverse the previous statement.
